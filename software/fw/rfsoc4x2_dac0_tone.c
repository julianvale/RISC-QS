/* Independent DAC0 tone firmware for the accepted RFSoC4x2 platform.
 *
...
int main(void) {
    ...
    set_freq(RF_CH0, RFSOC4X2_FREQ_WORD);
    set_phase(RF_CH0, 0, RFSOC4X2_PHASE_WORD);
    set_amp(RF_CH0, 0, RFSOC4X2_AMP_WORD);
    set_env(RF_CH0, 0, RFSOC4X2_ENV_WORD);
    set_dur(RF_CH0, 0, RFSOC4X2_DUR_WORD);
