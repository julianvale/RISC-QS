...
# 491.52 MHz / (2 * 128) = 1.92 MHz.  492 ticks = 1 us at 491.52 MHz.
DEFAULT_HALF_PERIOD = 25
DEFAULT_DURATION = 492
SCHEDULE_LEAD = 2_048
SETTLE_TICKS = 64
...
def laser_burst(out: Array, half_period: int, duration: int, cw: int):
    ...
    play_laser(half_period, duration, cw, start+duration+100)
    wait_until(start + duration + duration + SETTLE_TICKS + 100)  # noqa: F821
    out[0] = start
    out[1] = half_period
    out[2] = duration
    out[3] = cw
